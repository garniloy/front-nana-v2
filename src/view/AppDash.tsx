    ...
    return(
            ...
            <div className="main" >
                ...
                <div className="user-menu" >
                    <UserMenu onClose={()=>{close()}} username={user.name} userId={user.id} showStatBtn= {user?.owner || user?.role === 'superuser'} onGoStats={()=>{navigate('/dashboard')}} onLogout={()=>{logOut()}}></UserMenu>
                </div>}
                <div className="cadre">
                    <div className="display-zone">
                        <div className="side-zone" data-style="neuro" data-mode="light">
                            ...
                            <div className="sidebar"  >
                                ...
                                <NavLink to="/app/charge-cashout" className= {({ isActive }) => isActive ? "nav-item  active" : "nav-item btn"} >
                                    <svg width="24" height="24" className="sidebar-icon" fill="#3f4a41" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
